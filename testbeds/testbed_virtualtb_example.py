...
env.virtual_nodes_info = {
    host1: {
        ...
        'image_name': '06f231fa-4264-444d-a373-cb648b976462',
        'flavor': '3',
        'vn_id': 'f0cd51f0-8be8-4ccf-bc07-cf96fe85f325',
        'mac-address': '06:af:b6:a7:33:c6',
    },
    host2: {
        'keystone_ip': '10.204.217.119',
        'keystone_authip': '192.168.22.2',
    ...
    host3: {
        ...
        'flavor': '3',
        'vn_id': 'f0cd51f0-8be8-4ccf-bc07-cf96fe85f325',
        'mac-address': '06:af:b6:a7:33:c8',
    },
}

env.hostnames = {
    'all': ['nodei7-test-vm1', 'nodei7-test-vm2', 'nodei7-test-vm3', 'nodea10']
}
