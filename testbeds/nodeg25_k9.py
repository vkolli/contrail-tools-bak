...
static_route  = {
   ...
   # host4 : [{ 'ip': '40.40.0.0', 'netmask' : '255.248.0.0', 'gw':'40.41.1.1', 'intf': 'vlan4001' }
   # ],
    host5 : [{ 'ip': '40.40.0.0', 'netmask' : '255.248.0.0', 'gw':'40.40.40.1', 'intf': 'vlan4000' }
    ],
    host6 : [{ 'ip': '40.40.0.0', 'netmask' : '255.248.0.0', 'gw':'40.40.40.1', 'intf': 'vlan4000' }
    ],
}
