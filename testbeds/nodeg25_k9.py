...
control_data = {
    ...
    host4 : { 'ip': '40.41.1.5/24', 'gw' : '41.41.40.2', 'device':'bond0','vlan': '4001' },
    host5 : { 'ip': '40.40.40.5/24', 'gw' : '40.40.40.1', 'device':'bond0' ,'vlan': '4000'},
    host6 : { 'ip': '40.40.40.6/24','gw' : '40.40.40.1', 'device':'eth2','vlan': '4000' },
}

static_route  = {
    host1 : [{ 'ip': '40.40.0.0/13', 'netmask' : '255.248.0.0', 'gw':'40.43.1.1', 'intf': 'eth1' }
],
    host2 : [{ 'ip': '40.40.0.0/13', 'netmask' : '255.248.0.0', 'gw':'40.43.1.1', 'intf': 'eth1' }
],
    host3 : [{ 'ip': '40.40.0.0/13', 'netmask' : '255.248.0.0', 'gw':'40.43.1.1', 'intf': 'eth1' }
],
    host4 : [{ 'ip': '40.40.0.0/13', 'netmask' : '255.248.0.0', 'gw':'40.41.1.1', 'intf': 'vlan4001' }
],
    host5 : [{ 'ip': '40.40.0.0/13', 'netmask' : '255.248.0.0', 'gw':'40.40.40.1', 'intf': 'vlan4000' }
],
    host6 : [{ 'ip': '40.40.0.0/13', 'netmask' : '255.248.0.0', 'gw':'40.40.40.1', 'intf': 'vlan4000' }
],
}
