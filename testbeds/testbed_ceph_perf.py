...
#Data Interface
control_data = {
   host1 : { 'ip': '10.87.140.197/19', 'gw' : '5.0.0.1', 'device':'eth0' },
   host2 : { 'ip': '10.87.140.198/19', 'gw' : '5.0.0.1', 'device':'eth0' },
   host3 : { 'ip': '10.87.140.199/19', 'gw' : '5.0.0.1', 'device':'eth0' },
   host4 : { 'ip': '10.87.140.200/19', 'gw' : '5.0.0.1', 'device':'eth0' },
}
