...
host4 = 'root@10.87.64.153' # Netronome 40G card
...
env.hostnames = {
    'all': ['5b3s45', '5b4s30', '5b4s39','5b4s25']
}
...
static_route  = {
     ...
     host4 : [{ 'ip': '5.5.0.0', 'netmask' : '255.255.0.0', 'gw':'5.5.5.1', 'intf': 'nfp_p0' }, {'ip': '6.6.0.0', 'netmask' : '255.255.0.0', 'gw':'5.5.5.1', 'intf': 'nfp_p0' }]
}
