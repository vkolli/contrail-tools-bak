...
#Inferface Bonding
bond= {
    host1 : { 'name': 'bond0', 'member': ['enp4s0f0', 'enp4s0f1'], 'mode': '802.3ad', 'xmit_hash_policy': 'layer3+4' },
    host2 : { 'name': 'bond0', 'member': ['enp4s0f0', 'enp4s0f1'], 'mode': '802.3ad', 'xmit_hash_policy': 'layer3+4' },
    host3 : { 'name': 'bond0', 'member': ['enp4s0f0', 'enp4s0f1'], 'mode': '802.3ad', 'xmit_hash_policy': 'layer3+4' },
    host4 : { 'name': 'bond0', 'member': ['p4p0p0', 'p4p0p1'], 'mode': '802.3ad', 'xmit_hash_policy': 'layer3+4' },
    host5 : { 'name': 'bond0', 'member': ['p4p0p0', 'p4p0p1'], 'mode': '802.3ad', 'xmit_hash_policy': 'layer3+4' },
    host6 : { 'name': 'bond0', 'member': ['p4p0p0', 'p4p0p1'], 'mode': '802.3ad', 'xmit_hash_policy': 'layer3+4' },
    host7 : { 'name': 'bond0', 'member': ['p4p0p0', 'p4p0p1'], 'mode': '802.3ad', 'xmit_hash_policy': 'layer3+4' },
}
