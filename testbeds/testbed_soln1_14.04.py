...
#Inferface Bonding             
bond= {                        
        host1 : { 'name': 'bond0', 'member': ['p1p1','p1p2'], 'mode':'802.3ad' }, 
	host2 : { 'name': 'bond0', 'member': ['p1p1','p1p2'], 'mode':'802.3ad' }, 
	host3 : { 'name': 'bond0', 'member': ['p1p1','p1p2'], 'mode':'802.3ad' }, 
	host4 : { 'name': 'bond0', 'member': ['p1p1','p1p2'], 'mode':'802.3ad' }, 
	host5 : { 'name': 'bond0', 'member': ['p1p1','p1p2'], 'mode':'802.3ad' }, 
	host6 : { 'name': 'bond0', 'member': ['p1p1','p1p2'], 'mode':'802.3ad' }, 
	host7 : { 'name': 'bond0', 'member': ['p1p1','p1p2'], 'mode':'802.3ad' }, 
	host8 : { 'name': 'bond0', 'member': ['p1p1','p1p2'], 'mode':'802.3ad' }, 
	host9 : { 'name': 'bond0', 'member': ['p1p1','p1p2'], 'mode':'802.3ad' }, 
	}
